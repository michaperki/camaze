...
const { isSubscriptionLine, isNonModelLine } = require("./costs");
...
// pick excludes subscription lines and Google's non-model GCP charges
// (Compute Engine, Storage, support, etc.) — neither can spike, so neither
// can ever be "what drove" a spike. Same classification lib/costs.js's
// per-day usage split uses, so a driver pick can't disagree with the usage
